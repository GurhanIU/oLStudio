...
/*!
   ...
   \brief EDesignerWidgetDataBaseInterface class provides an interface that used to
...
EDesignerWidgetDataBaseInterface::EDesignerWidgetDataBaseInterface(QObject *parent) : QObject(parent)
{
}

/*!
    Destroy the interface to the widget database
*/

EDesignerWidgetDataBaseInterface::~EDesignerWidgetDataBaseInterface()
{
    qDeleteAll(m_items);
}
...
int EDesignerWidgetDataBaseInterface::count() const
{
...
/*!
*/
EDesignerWidgetDataBaseItemInterface *EDesignerWidgetDataBaseInterface::item(int index) const
{
...
int EDesignerWidgetDataBaseInterface::indexOf(EDesignerWidgetDataBaseItemInterface *item) const
{
...
/*!
*/
void EDesignerWidgetDataBaseInterface::insert(int index, EDesignerWidgetDataBaseItemInterface *item)
{
...
/*!
*/
void EDesignerWidgetDataBaseInterface::append(EDesignerWidgetDataBaseItemInterface *item)
{
    if (debugWidgetDataBase)
...
EDesignerFormEditorInterface *EDesignerWidgetDataBaseInterface::core() const
{
    return 0;
}
...
/*!
*/
int EDesignerWidgetDataBaseInterface::indexOfClassName(const QString &name, bool resolveName) const
{
    const int itemCount = count();
    for (int i = 0; i < itemCount; ++i)
    {
        const EDesignerWidgetDataBaseItemInterface *entry = item(i);
        if (entry->name() == name)
            return i;
    }
...
/*!
*/
int EDesignerWidgetDataBaseInterface::indexOfObject(QObject *object, bool resolveName) const
{
    if (!object)
        return -1;
...
/*!
*/
bool EDesignerWidgetDataBaseInterface::isContainer(QObject *object, bool resolveName) const
{
    if (const EDesignerWidgetDataBaseItemInterface *i = item(indexOfObject(object, resolveName)))
...
bool EDesignerWidgetDataBaseInterface::isCustom(QObject *object, bool resolveName) const
{
    if (const EDesignerWidgetDataBaseItemInterface *i = item(indexOfObject(object, resolveName)))
        return i->isCustom();
    return false;
