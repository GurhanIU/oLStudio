...
#else
    friend class EAbstractFormBuilder;
#endif
};
...
EAbstractFormBuilder::EAbstractFormBuilder() :
    m_defaultMargin(INT_MIN),
    m_defaultSpacing(INT_MIN)
{
    setResourceBuilder(new EResourceBuilder());
    setTextBuilder(new ETextBuilder());
}
...
EAbstractFormBuilder::~EAbstractFormBuilder()
{
    EFormBuilderExtra::removeInstance(this);
}
...
/*!
    ...
    \sa save()
*/
QWidget *EAbstractFormBuilder::load(QIODevice *dev, QWidget *parentWidget)
{
    ...
    while (!reader.atEnd())
    {
        if (reader.readNext() == QXmlStreamReader::StartElement)
        {
            ...
            {
                reader.raiseError(QCoreApplication::translate("EAbstractFormBuilder", "Unexpected element <%1>").arg(reader.name().toString()));
            }
        }
    }
    if (reader.hasError())
    {
        uiLibWarning(QCoreApplication::translate("EAbstractFormBuilder", "An error has occurred while reading the UI file at line %1, column %2: %3")
    ...
    if (!initialized)
    {
        uiLibWarning(QCoreApplication::translate("EAbstractFormBuilder", "Invalid UI file: The root element <ui> is missing."));
        return 0;
    }
...
/*!
    \internal
*/
QWidget *EAbstractFormBuilder::create(DomUI *ui, QWidget *parentWidget)
{
    typedef EFormBuilderExtra::ButtonGroupHash ButtonGroupHash;

    EFormBuilderExtra *formBuilderPrivate = EFormBuilderExtra::instance(this);
...
void EAbstractFormBuilder::initialize(const DomUI *ui)
{
...
/*!
    \internal
*/
QWidget *EAbstractFormBuilder::create(DomWidget *ui_widget, QWidget *parentWidget)
{
    ...
    EFormBuilderExtra *extra = EFormBuilderExtra::instance(this);
...
/*!
    \internal
*/
QAction *EAbstractFormBuilder::create(DomAction *ui_action, QObject *parent)
{
...
/*!
    \internal
*/
QActionGroup *EAbstractFormBuilder::create(DomActionGroup *ui_action_group, QObject *parent)
{
...
Qt::ToolBarArea EAbstractFormBuilder::toolbarAreaFromDOMAttributes(const DomPropertyHash &attributes) {
    const DomProperty *attr = attributes.value(EFormBuilderStrings::instance().toolBarAreaAttribute);
    if (!attr)
    ...
    case DomProperty::Enum:
        return enumKeyOfObjectToValue<EAbstractFormBuilderGadget, Qt::ToolBarArea>("toolBarArea",  attr->elementEnum().toLatin1());
    default:
        break;
    }
    return Qt::TopToolBarArea;
...
/*!
    \internal
*/
bool EAbstractFormBuilder::addItem(DomWidget *ui_widget, QWidget *widget, QWidget *parentWidget)
{
    const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    ...
    const QString addPageMethod = EFormBuilderExtra::instance(this)->customWidgetAddPageMethod(className);
...
/*!
    \internal
*/
void EAbstractFormBuilder::layoutInfo(DomLayout *ui_layout, QObject *parent, int *margin, int *spacing)
{
    Q_UNUSED(parent)
    const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    ...
    if (mar != INT_MIN) {
        const int defaultMargin = parent->inherits("ELayoutWidget") ? 0 : 9;
...
/*!
    \internal
*/
QLayout *EAbstractFormBuilder::create(DomLayout *ui_layout, QLayout *parentLayout, QWidget *parentWidget)
{
    ...
    if (QBoxLayout *box = qobject_cast<QBoxLayout*>(layout))
    {
        ...
        if (!boxStretch.isEmpty())
            EFormBuilderExtra::setBoxLayoutStretch(boxStretch, box);
    }
...
/*!
    \internal
*/
bool EAbstractFormBuilder::addItem(DomLayoutItem *ui_item, QLayoutItem *item, QLayout *layout)
{
    ...
    else if (item->spacerItem())// nothing to do
    {       }
    else
        return false;    
...
/*!
    \internal
*/
QLayoutItem *EAbstractFormBuilder::create(DomLayoutItem *ui_layoutItem, QLayout *layout, QWidget *parentWidget)
{
...
//#endif
    ...
    case DomLayoutItem::Spacer: {
        ...
        if (!spacerProperties.empty())
        {
            ...
            {
                const QVariant v = toVariant(&EAbstractFormBuilderGadget::staticMetaObject, p); // ### remove me
                if (v.isNull())
                    continue;
...
/*!
    \internal
*/
void EAbstractFormBuilder::applyProperties(QObject *o, const QList<DomProperty*> &properties)
{
...
bool EAbstractFormBuilder::applyPropertyInternally(QObject *o, const QString &propertyName, const QVariant &value)
{
    return EFormBuilderExtra::instance(this)->applyPropertyInternally(o,propertyName, value);
}
...
QVariant EAbstractFormBuilder::toVariant(const QMetaObject *meta, DomProperty *p)
{
...
/*!
    \internal
*/
void EAbstractFormBuilder::setupColorGroup(QPalette &palette, QPalette::ColorGroup colorGroup,
            DomColorGroup *group)
{
    // old format
    ...
    // new format
    const QMetaEnum colorRole_enum = metaEnum<EAbstractFormBuilderGadget>("colorRole");
...
/*!
    \internal
*/
DomColorGroup *EAbstractFormBuilder::saveColorGroup(const QPalette &palette)
{
...
/*!
    \internal
*/
QBrush EAbstractFormBuilder::setupBrush(DomBrush *brush)
{
    QBrush br;
    if (!brush->hasAttributeBrushStyle())
        return br;

    const Qt::BrushStyle style = enumKeyOfObjectToValue<EAbstractFormBuilderGadget, Qt::BrushStyle>("brushStyle", brush->attributeBrushStyle().toLatin1());

    if (style == Qt::LinearGradientPattern || style == Qt::RadialGradientPattern || style == Qt::ConicalGradientPattern)
    {
        const QMetaEnum gradientType_enum = metaEnum<EAbstractFormBuilderGadget>("gradientType");
        const QMetaEnum gradientSpread_enum = metaEnum<EAbstractFormBuilderGadget>("gradientSpread");
        const QMetaEnum gradientCoordinate_enum = metaEnum<EAbstractFormBuilderGadget>("gradientCoordinate");
...
/*!
    \internal
*/
DomBrush *EAbstractFormBuilder::saveBrush(const QBrush &br)
{
    const QMetaEnum brushStyle_enum = metaEnum<EAbstractFormBuilderGadget>("brushStyle");
...
/*!
    \internal
*/
QWidget *EAbstractFormBuilder::createWidget(const QString &widgetName, QWidget *parentWidget, const QString &name)
{
    Q_UNUSED(widgetName);
...
/*!
    \internal
*/
QLayout *EAbstractFormBuilder::createLayout(const QString &layoutName, QObject *parent, const QString &name)
{
    Q_UNUSED(layoutName);
    Q_UNUSED(parent);
    Q_UNUSED(name);
...
/*!
    \internal
*/
QAction *EAbstractFormBuilder::createAction(QObject *parent, const QString &name)
{
...
/*!
    \internal
*/
QActionGroup *EAbstractFormBuilder::createActionGroup(QObject *parent, const QString &name)
{
...
/*!
    ...
    \sa load()*/
void EAbstractFormBuilder::save(QIODevice *dev, QWidget *widget)
{
...
/*!
    \internal
*/
void EAbstractFormBuilder::saveDom(DomUI *ui, QWidget *widget)
{
...
/*!
    \internal
*/
DomConnections *EAbstractFormBuilder::saveConnections()
{
...
DomWidget *EAbstractFormBuilder::createDom(QWidget *widget, DomWidget *ui_parentWidget, bool recursive)
{
    ...
    foreach (QObject *obj, children)
    {
        ...
        {
            if (childAction->actionGroup() != 0) // it will be added later.
                continue;            
...
/*!
    \internal
*/
DomActionRef *EAbstractFormBuilder::createActionRefDom(QAction *action)
{
    ...
    if (action->isSeparator())
        ui_action_ref->setAttributeName(EFormBuilderStrings::instance().separator);
    else
...
// filter out the case of "Spacer" and "ELayoutWidget" widgets
void FormBuilderSaveLayoutEntry::setAlignment(Qt::Alignment al)
{
    ...
    if (className == QLatin1String("Spacer")
            || className == QLatin1String("ELayoutWidget")) // ELayoutWidget
        return;
...
DomLayout *EAbstractFormBuilder::createDom(QLayout *layout, DomLayout *ui_layout, DomWidget *ui_parentWidget)
{
    Q_UNUSED(ui_layout)
...
/*!
    \internal
*/
DomLayoutItem *EAbstractFormBuilder::createDom(QLayoutItem *item, DomLayout *ui_layout, DomWidget *ui_parentWidget)
{
...
/*!
    \internal
*/
DomSpacer *EAbstractFormBuilder::createDom(QSpacerItem *spacer, DomLayout *ui_layout, DomWidget *ui_parentWidget)
{
    Q_UNUSED(ui_layout);
...
/*!
    \internal
*/
DomProperty *EAbstractFormBuilder::createProperty(QObject *obj, const QString &pname, const QVariant &v)
{
...
/*!
    \internal
*/
QList<DomProperty*> EAbstractFormBuilder::computeProperties(QObject *obj)
{
...
/*!
    \internal
*/
EAbstractFormBuilder::DomPropertyHash EAbstractFormBuilder::propertyMap(const QList<DomProperty*> &properties)
{
    DomPropertyHash map;
...
/*!
    \internal
*/
bool EAbstractFormBuilder::checkProperty(QObject *obj, const QString &prop) const
{
    Q_UNUSED(obj);
    Q_UNUSED(prop);
...
/*!
    \internal
*/
QString EAbstractFormBuilder::toString(const DomString *str)
{
...
/*!
    \internal
*/
void EAbstractFormBuilder::applyTabStops(QWidget *widget, DomTabStops *tabStops)
{
    if (!tabStops)
        return;
...
/*!
    \internal
*/
DomCustomWidgets *EAbstractFormBuilder::saveCustomWidgets()
{
    return 0;
}
...
/*!
    \internal
*/
DomTabStops *EAbstractFormBuilder::saveTabStops()
{
    return 0;
}
...
/*!
    \internal
*/
DomResources *EAbstractFormBuilder::saveResources()
{
    return 0;
}
...
DomButtonGroups *EAbstractFormBuilder::saveButtonGroups(const QWidget *mainContainer)
{
...
class FriendlyFB : public EAbstractFormBuilder {
public:
    using EAbstractFormBuilder::saveResource;
    using EAbstractFormBuilder::saveText;
    using EAbstractFormBuilder::resourceBuilder;
    using EAbstractFormBuilder::textBuilder;
    using EAbstractFormBuilder::toVariant;
};

template<class T>
static void storeItemFlags(const T *item, QList<DomProperty*> *properties)
{
    static const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    static const Qt::ItemFlags defaultFlags = T().flags();
    static const QMetaEnum itemFlags_enum = metaEnum<EAbstractFormBuilderGadget>("itemFlags");
...
template<class T>
static void storeItemProps(EAbstractFormBuilder *abstractFormBuilder, const T *item,
        QList<DomProperty*> *properties)
{
    static const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    ...
    foreach (const EFormBuilderStrings::TextRoleNName &it, strings.itemTextRoles)
    {
        if ((p = formBuilder->saveText(it.second, item->data(it.first.second))))
            properties->append(p);
    }

    foreach (const EFormBuilderStrings::RoleNName &it, strings.itemRoles)
    {
        if ((v = item->data(it.first)).isValid() &&
            (p = variantToDomProperty(abstractFormBuilder,
                static_cast<const QMetaObject *>(&EAbstractFormBuilderGadget::staticMetaObject),
                it.second, v)))
            properties->append(p);
    }
...
template<class T>
static void storeItemPropsNFlags(EAbstractFormBuilder *abstractFormBuilder, const T *item,
        QList<DomProperty*> *properties)
{
...
template<class T>
static void loadItemProps(EAbstractFormBuilder *abstractFormBuilder, T *item,
        const QHash<QString, DomProperty*> &properties)
{
    ...
    {
        if ((p = properties.value(it.second)) &&
            (v = formBuilder->toVariant(&EAbstractFormBuilderGadget::staticMetaObject, p)).isValid())
...
template<class T>
static void loadItemPropsNFlags(EAbstractFormBuilder *abstractFormBuilder, T *item,
        const QHash<QString, DomProperty*> &properties)
{
    static const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    static const QMetaEnum itemFlags_enum = metaEnum<EAbstractFormBuilderGadget>("itemFlags");
...
static void storeItemProps(EAbstractFormBuilder *abstractFormBuilder, const QTableWidgetItem *item,
        QList<DomProperty*> *properties)
{
    static const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    FriendlyFB * const formBuilder = static_cast<FriendlyFB *>(abstractFormBuilder);
...
/*!
    \internal
*/
void EAbstractFormBuilder::saveTreeWidgetExtraInfo(QTreeWidget *treeWidget, DomWidget *ui_widget, DomWidget *ui_parentWidget)
{
    Q_UNUSED(ui_parentWidget);
    ...
    for (int c = 0; c<treeWidget->columnCount(); ++c)
    {
        ...
        foreach (const EFormBuilderStrings::RoleNName &it, strings.itemRoles)
        {
            if ((v = treeWidget->headerItem()->data(c, it.first)).isValid() &&
                (p = variantToDomProperty(this, &EAbstractFormBuilderGadget::staticMetaObject, it.second, v)))
                properties.append(p);
        }
...
/*!
    \internal
*/
void EAbstractFormBuilder::saveTableWidgetExtraInfo(QTableWidget *tableWidget, DomWidget *ui_widget, DomWidget *ui_parentWidget)
{
    Q_UNUSED(ui_parentWidget);
...
/*!
    \internal
*/
void EAbstractFormBuilder::saveListWidgetExtraInfo(QListWidget *listWidget, DomWidget *ui_widget, DomWidget *ui_parentWidget)
{
    Q_UNUSED(ui_parentWidget);
...
/*!
    \internal
*/
void EAbstractFormBuilder::saveComboBoxExtraInfo(QComboBox *comboBox, DomWidget *ui_widget, DomWidget *ui_parentWidget)
{
    Q_UNUSED(ui_parentWidget);
    QList<DomItem*> ui_items = ui_widget->elementItem();
    ...
    for (int i=0; i < count; ++i)
    {
        ...
        DomProperty *textProperty = saveText(EFormBuilderStrings::instance().textAttribute, comboBox->itemData(i, Qt::DisplayPropertyRole));
...
void EAbstractFormBuilder::saveButtonExtraInfo(const QAbstractButton *widget, DomWidget *ui_widget, DomWidget *)
{
    typedef QList<DomProperty*> DomPropertyList;
...
/*!
    ...
    \since 4.5
*/
void EAbstractFormBuilder::saveItemViewExtraInfo(const QAbstractItemView *itemView,
...
void EAbstractFormBuilder::setResourceBuilder(EResourceBuilder *builder)
{
    EFormBuilderExtra::instance(this)->setResourceBuilder(builder);
}
...
EResourceBuilder *EAbstractFormBuilder::resourceBuilder() const
{
    return EFormBuilderExtra::instance(this)->resourceBuilder();
}
...
void EAbstractFormBuilder::setTextBuilder(ETextBuilder *builder)
{
    EFormBuilderExtra::instance(this)->setTextBuilder(builder);
}
...
ETextBuilder *EAbstractFormBuilder::textBuilder() const
{
    return EFormBuilderExtra::instance(this)->textBuilder();
}

/*!
    \internal
*/
void EAbstractFormBuilder::saveExtraInfo(QWidget *widget, DomWidget *ui_widget,
...
/*!
    \internal
*/
void EAbstractFormBuilder::loadListWidgetExtraInfo(DomWidget *ui_widget, QListWidget *listWidget, QWidget *parentWidget)
{
    Q_UNUSED(parentWidget);
    const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
...
/*!
    \internal
*/
void EAbstractFormBuilder::loadTreeWidgetExtraInfo(DomWidget *ui_widget, QTreeWidget *treeWidget, QWidget *parentWidget)
{
    Q_UNUSED(parentWidget);
    const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    const QMetaEnum itemFlags_enum = metaEnum<EAbstractFormBuilderGadget>("itemFlags");
    ...
    for (int i = 0; i<columns.count(); ++i)
    {
        ...
        {
            if ((p = properties.value(it.second)) &&
                (v = toVariant(&EAbstractFormBuilderGadget::staticMetaObject, p)).isValid())
        ...
        foreach (DomProperty *property, properties)
        {
            ...
            else if (col >= 0)
            {
                ...
                else
                {
                    ...
                    if (role >= 0)
                    {
                        if ((v = toVariant(&EAbstractFormBuilderGadget::staticMetaObject, property)).isValid())
...
/*!
    \internal
*/
void EAbstractFormBuilder::loadTableWidgetExtraInfo(DomWidget *ui_widget, QTableWidget *tableWidget, QWidget *parentWidget)
{
    Q_UNUSED(parentWidget);
...
/*!
    \internal
*/
void EAbstractFormBuilder::loadComboBoxExtraInfo(DomWidget *ui_widget, QComboBox *comboBox, QWidget *parentWidget)
{
    Q_UNUSED(parentWidget);
    const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    foreach (DomItem *ui_item, ui_widget->elementItem())
...
void EAbstractFormBuilder::loadButtonExtraInfo(const DomWidget *ui_widget, QAbstractButton *button, QWidget *)
{
    typedef EFormBuilderExtra::ButtonGroupHash ButtonGroupHash;
...
/*!
    ...
    \since 4.5
*/
void EAbstractFormBuilder::loadItemViewExtraInfo(DomWidget *ui_widget, QAbstractItemView *itemView,
                                                 QWidget *)
{
    //
    // Special handling for qtableview/qtreeview fake header attributes
...
/*!
    \internal
*/
void EAbstractFormBuilder::loadExtraInfo(DomWidget *ui_widget, QWidget *widget, QWidget *parentWidget)
{
    const EFormBuilderStrings &strings = EFormBuilderStrings::instance();
    if (0) {
...
/*!
    \internal
*/
QIcon EAbstractFormBuilder::nameToIcon(const QString &filePath, const QString &qrcPath)
{
    Q_UNUSED(filePath)
    Q_UNUSED(qrcPath)
...
/*!
    \internal
*/
QString EAbstractFormBuilder::iconToFilePath(const QIcon &pm) const
{
    Q_UNUSED(pm)
...
/*!
    \internal
*/
QString EAbstractFormBuilder::iconToQrcPath(const QIcon &pm) const
{
    Q_UNUSED(pm)
...
/*!
    \internal
*/
QPixmap EAbstractFormBuilder::nameToPixmap(const QString &filePath, const QString &qrcPath)
{
    Q_UNUSED(filePath)
    Q_UNUSED(qrcPath)
...
/*!
    \internal
*/
QString EAbstractFormBuilder::pixmapToFilePath(const QPixmap &pm) const
{
    Q_UNUSED(pm)
...
/*!
    \internal
*/
QString EAbstractFormBuilder::pixmapToQrcPath(const QPixmap &pm) const
{
    Q_UNUSED(pm)
...
QDir EAbstractFormBuilder::workingDirectory() const
{
...
/*!
    ...
    \sa workingDirectory()*/
void EAbstractFormBuilder::setWorkingDirectory(const QDir &directory)
{
...
/*!
    \internal
*/
DomAction *EAbstractFormBuilder::createDom(QAction *action)
{
...
DomButtonGroup *EAbstractFormBuilder::createDom(QButtonGroup *buttonGroup)
{
...
/*!
    \internal
*/
DomActionGroup *EAbstractFormBuilder::createDom(QActionGroup *actionGroup)
{
...
/*!
    \internal
*/
void EAbstractFormBuilder::addMenuAction(QAction *action)
{
    Q_UNUSED(action);
}
...
/*!
    \internal
*/
void EAbstractFormBuilder::reset()
{
    m_laidout.clear();
    m_actions.clear();
...
QMetaEnum EAbstractFormBuilder::toolBarAreaMetaEnum()
{
    return metaEnum<EAbstractFormBuilderGadget>("toolBarArea");
}
...
EAbstractFormBuilder::IconPaths EAbstractFormBuilder::iconPaths(const QIcon &icon) const
{
    Q_UNUSED(icon);
...
EAbstractFormBuilder::IconPaths EAbstractFormBuilder::pixmapPaths(const QPixmap &pixmap) const
{
    Q_UNUSED(pixmap);
...
void EAbstractFormBuilder::setIconProperty(DomProperty &p, const IconPaths &ip) const
{
...
*/
    ...
    p.setAttributeName(EFormBuilderStrings::instance().iconAttribute);
...
void EAbstractFormBuilder::setPixmapProperty(DomProperty &p, const IconPaths &ip) const
{
    ...
    p.setAttributeName(EFormBuilderStrings::instance().pixmapAttribute);
...
DomProperty* EAbstractFormBuilder::iconToDomProperty(const QIcon &icon) const
{
    Q_UNUSED(icon);
...
DomProperty *EAbstractFormBuilder::saveResource(const QVariant &v) const
{
    if (v.isNull())
        return 0;
...
DomProperty *EAbstractFormBuilder::saveText(const QString &attributeName, const QVariant &v) const
{
    if (v.isNull())
        return 0;
...
const DomResourcePixmap *EAbstractFormBuilder::domPixmap(const DomProperty* p) {
    switch (p->kind()) {
...
QIcon EAbstractFormBuilder::domPropertyToIcon(const DomResourcePixmap *icon)
{
    Q_UNUSED(icon);
...
QIcon EAbstractFormBuilder::domPropertyToIcon(const DomProperty* p)
{
    Q_UNUSED(p);
    qWarning() << "QAbstractFormBuilder::domPropertyToIcon() is obsoleted";
    return QIcon();
...
QPixmap EAbstractFormBuilder::domPropertyToPixmap(const DomResourcePixmap* pixmap)
{
    Q_UNUSED(pixmap);
...
QPixmap EAbstractFormBuilder::domPropertyToPixmap(const DomProperty* p)
{
    Q_UNUSED(p);
    qWarning() << "QAbstractFormBuilder::domPropertyToPixmap() is obsoleted";
    return QPixmap();
...
*/
#ifndef QT_FORMBUILDER_NO_SCRIPT
EFormScriptRunner *EAbstractFormBuilder::formScriptRunner() const
{
    return &(EFormBuilderExtra::instance(this)->formScriptRunner());
}
#endif
...
void EAbstractFormBuilder::setScriptingEnabled(bool enabled)
{
...
#else
    EFormScriptRunner::Options options = formScriptRunner()->options();
    if (enabled)
        options &= ~EFormScriptRunner::DisableScripts;
    else
        options |= EFormScriptRunner::DisableScripts;
...
bool EAbstractFormBuilder::isScriptingEnabled() const
{
#ifdef QT_FORMBUILDER_NO_SCRIPT
    return false;
#else
    return !(formScriptRunner()->options() & EFormScriptRunner::DisableScripts);
#endif
}
