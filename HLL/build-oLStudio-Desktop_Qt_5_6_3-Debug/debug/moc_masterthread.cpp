...
#include "../../project/src/objects/masterthread.h"
...
QT_MOC_LITERAL(6, 38, 5), // "error"
QT_MOC_LITERAL(7, 44, 7) // "timeout"

    },
    "MasterThread\0response\0\0s\0request\0data\0"
    "error\0timeout"
};
...
void MasterThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->request((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (MasterThread::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MasterThread::request)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void MasterThread::request(QByteArray _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
