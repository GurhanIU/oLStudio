...
*/
EDesignerWidgetBoxInterface::EDesignerWidgetBoxInterface(QWidget *parent, Qt::WindowFlags flags)
...
*/
EDesignerWidgetBoxInterface::~EDesignerWidgetBoxInterface()
{
}
...
/*!
    \internal
*/
int EDesignerWidgetBoxInterface::findOrInsertCategory(const QString &categoryName)
{
