...
#pragma qt_class(EAbstractFormBuilder)
#endif
...
{
public:
    EAbstractFormBuilder();
    virtual ~EAbstractFormBuilder();
...
#ifndef QT_FORMBUILDER_NO_SCRIPT
    EFormScriptRunner *formScriptRunner() const;
#endif
//
//  utils
//
...
//
    ...
    EAbstractFormBuilder(const EAbstractFormBuilder &other);
    void operator = (const EAbstractFormBuilder &other);

    friend DomProperty *variantToDomProperty(EAbstractFormBuilder *abstractFormBuilder, const QMetaObject *meta, const QString &propertyName, const QVariant &value);
    friend QVariant domPropertyToVariant(EAbstractFormBuilder *abstractFormBuilder,const QMetaObject *meta, const DomProperty *property);
};
