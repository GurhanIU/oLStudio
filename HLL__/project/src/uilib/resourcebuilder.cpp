...
EResourceBuilder::EResourceBuilder()
{
...
int EResourceBuilder::iconStateFlags(const DomResourceIcon *dpi)
{
    int rc = 0;
...
QVariant EResourceBuilder::loadResource(const QDir &workingDirectory, const DomProperty *property) const
{
...
QVariant EResourceBuilder::toNativeValue(const QVariant &value) const
{
    return value;
}

DomProperty *EResourceBuilder::saveResource(const QDir &workingDirectory, const QVariant &value) const
{
...
bool EResourceBuilder::isResourceProperty(const DomProperty *p) const
{
    switch (p->kind()) {
        case DomProperty::Pixmap:
        case DomProperty::IconSet:
...
bool EResourceBuilder::isResourceType(const QVariant &value) const
{
    switch (value.type()) {
