...
WidgetBox::WidgetBox(EDesignerFormEditorInterface *core, QWidget *parent, Qt::WindowFlags flags)
    : EDesignerWidgetBox(parent, flags),
      m_core(core),
...
EDesignerFormEditorInterface *WidgetBox::core() const
{
    return m_core;
}
...
EDesignerWidgetBoxInterface::Category WidgetBox::category(int cat_idx) const
{
...
EDesignerWidgetBoxInterface::Widget WidgetBox::widget(int cat_idx, int wgt_idx) const
{
...
//void WidgetBox::dropWidgets(const QList<EDesignerDnDItemInterface*> &item_list, const QPoint&)
//{
