...
#include "ui_settingsrtu.h"

SettingsRTU::SettingsRTU(QWidget *parent, CommSettings * settings) :
    QDialog(parent),
    ui(new Ui::SettingsRTU),
    m_settings(settings)
{
    ui->setupUi(this);
...
SettingsRTU::~SettingsRTU()
{
    delete ui;
}

void SettingsRTU::showEvent(QShowEvent * event)
{
...
void SettingsRTU::changesAccepted()
{
